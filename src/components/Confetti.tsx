...
const BITS = [
  ...
  { angle: 34, dist: '6.6rem', spin: '-300deg', delay: '30ms', color: 'var(--color-future)' },
  { angle: 62, dist: '4.8rem', spin: '440deg', delay: '10ms', color: 'var(--color-present)' },
  ...
  { angle: 146, dist: '6.2rem', spin: '-400deg', delay: '70ms', color: 'var(--color-role-noun)' },
  { angle: 174, dist: '4.6rem', spin: '360deg', delay: '0ms', color: 'var(--color-future)' },
  { angle: 202, dist: '6.8rem', spin: '-340deg', delay: '40ms', color: 'var(--color-present)' },
  ...
  { angle: 286, dist: '4.9rem', spin: '400deg', delay: '80ms', color: 'var(--color-role-noun)' },
  { angle: 314, dist: '6rem', spin: '-360deg', delay: '25ms', color: 'var(--color-present)' },
  { angle: 342, dist: '5.6rem', spin: '340deg', delay: '55ms', color: 'var(--color-future)' },
